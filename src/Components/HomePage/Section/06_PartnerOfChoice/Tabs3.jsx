          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-purple-100 p-4 rounded-lg">
              ...
              <p className="font-normal">
                ...
                every stage, ensuring that our AI solutions evolve to meet the
            ...
            <div className="bg-purple-200 p-4 rounded-lg">
              ...
              <p className="font-normal">
                ...
                encounter. We believe in providing exceptional support to ensure
                the seamless operation of our AI solutions.
              </p>
            </div>
          </div>
        </div>
