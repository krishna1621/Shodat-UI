...
const ExplainableAISection = () => {
  return (
    <>
      <div>
        <div className="left-0  z-20 mt-20 md:mb-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="text-lg md:text-xl lg:text-2xl font-normal font-Poppins text-black ml-5 md:ml-9 mt-4 md:mt-8 mb-4 md:mb-9 leading-9 md:leading-14">
            ...
            <h1 className="font-semibold text-4xl leading-10 text-black">
              Explainable AI (XAI)
            </h1>

            <p className="font-normal text-base leading-6 text-gray-600 align-bottom mt-4">
          ...
          <div className="text-lg md:text-xl lg:text-2xl font-normal font-Poppins text-black ml-5 md:ml-9 mt-4 md:mt-8 mb-4 md:mb-9 leading-9 md:leading-14">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 align-bottom mt-4">
              ...
              ethics and bias mitigation, ensuring fairness and accountability
              in every algorithm.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 align-bottom mt-4 mb-6 md:mb-0">
